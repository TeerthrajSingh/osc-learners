# 🌐 Open Source Club (OSC) - Learners Wall
...
3. **Branch**: `git checkout -b add-yourname`
4. Add your image to `assets/images/` and paste your card HTML in `index.html`.
5. **Commit & Push**: `git commit -m "Add profile card for [Name]"`
...
1. Simply clone the repository:
   ...
   ```
2. Open `index.html` directly in your favorite browser, or use VS Code's **Live Server** extension.
...
Attendence - 25/09/26 - Teerthraj Singh 26bcs10474